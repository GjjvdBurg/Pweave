...
def test_publish():
    ...
    test = (
        io.open("tests/publish/publish_test.html", "r").read().encode("utf-8")
    )
    ref = (
        io.open("tests/publish/publish_test_ref.html", "r")
        .read()
        .encode("utf-8")
    )
...
def test_publish_cell():
    ...
    test = (
        io.open("tests/publish/publish_test_cell.html", "r")
        .read()
        .encode("utf-8")
    )
    ref = (
